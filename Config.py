...
experience_data = [
    [
        "AEROSAN",
        "Bogotá, Colombia",
        "Logística aeroportuaria y carga aérea",
        "Auxiliar de Bodega / Auxiliar Documental",
        "2024 - 2025",
        [
    ...
    [
        "EMCOCABLES",
        "Cajicá, Colombia",
        "Fabricación de cables de acero, torones y alambres",
...
personal_data = [
    "Apasionado por la automatización, la tecnología educativa y la resolución creativa de problemas.",
    "Gran interés en la psicología del comportamiento humano y su aplicación en entornos de trabajo.",
    "Disfruto practicar fútbol y deportes al aire libre como ciclismo y senderismo.",
